...
import pogledi.controller.KandidatController;
...
public class Cordinator {
    ...
    private KandidatController dkController;
    ...
    public void otvoriFormuDodajKandidata() {
        dkController=new KandidatController(new FormaKandidat());
